...
//     //     // std::cout << "Size of the image in file " << wbArg_getInputFile(args, args.argc - 3) << " does not match. ";
...
//                     {
//                         if (errCnt < wbInternal::kErrorReportLimit)
//                             std::cout << "Image pixels do not match at position (" << i << "). [" << image[i] << ", " <<  solnImage[i] << "]\n";
//                         ++errCnt;
//                     }
//         }
